...
class Profile(AbstractUser):
    groups = models.ManyToManyField(
        ...
        related_name='profile_groups'  # agregado: relacion inversa a través de 'profile_groups'
    )
    ...
    user_permissions = models.ManyToManyField(
        ...
        related_name='profile_user_permissions'  # agregado: relacion inversa a través de 'profile_user_permissions'
    )
